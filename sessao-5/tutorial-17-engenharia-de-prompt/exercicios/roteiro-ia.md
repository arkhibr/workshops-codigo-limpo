...
- `sessao-5/tutorial-17-engenharia-de-prompt/exemplos/preco_gerado.py` — veja o defeito de regra de negócio em código polido
- `sessao-5/tutorial-17-engenharia-de-prompt/exercicios/exercicio.py` — o módulo que você vai analisar e corrigir
...
```bash
python3 sessao-5/tutorial-17-engenharia-de-prompt/exercicios/exercicio.py
python3 sessao-5/tutorial-17-engenharia-de-prompt/exercicios/gabarito.py
```
