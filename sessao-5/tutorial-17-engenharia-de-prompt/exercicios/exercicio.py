...
Suas tarefas:
  ...
  3. Corrija o código e compare com gabarito.py.
"""
...
def determinar_faixa(valor: float) -> tuple[str, float]:
    ...
    Faixas:
      ...
      Ouro:   R$ 500,00+ → 20 %
    """
    if valor > FAIXA_OURO_MIN:       # ← defeito sutil: deveria ser >=
        return "ouro", DESCONTO_OURO
    if valor > FAIXA_PRATA_MIN:      # ← defeito sutil: deveria ser >=
...
if __name__ == "__main__":
    print("=== Cupom Progressivo (exercício — saída de IA com defeito sutil) ===\n")
    ...
    print()
    print("Casos de fronteira (revelam o defeito):")
