...
- `sessao-5/tutorial-19-multiarquivo-agentes/exercicios/exercicio_carrinho.py` —
  o módulo com o chamador não atualizado
- `sessao-5/tutorial-19-multiarquivo-agentes/exercicios/exercicio_precificacao.py` —
