# Tutorial 22 — Segurança em Código Gerado por IA
...
- Tutorial 20 — Revisão Crítica de Código Gerado por IA: o Modo 3 (segurança sutil)
- Tutorial 17 — Engenharia de Contexto e Prompt: como pedir com requisitos de segurança
- OWASP SQL Injection Prevention Cheat Sheet — parametrização e allow-lists

---

> **Próximo tutorial:** [Tutorial 23 — Testes guard-rails e manutenibilidade](../tutorial-23-testes-manutenibilidade/README.md)
