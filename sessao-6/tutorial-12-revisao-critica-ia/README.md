...
- Tutorial 09 — Engenharia de Contexto e Prompt: como o prompt afeta os defeitos gerados
- Tutorial 14 — Segurança em Código Gerado (Sessão 6): aprofundamento do Modo 3

---

> **Próximo tutorial:** [Tutorial 13 — Refatoração Assistida Avançada](../tutorial-13-refatoracao-assistida/README.md)
